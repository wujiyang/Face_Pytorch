...
@desc: For AgeDB-30 and CFP-FP test dataset, we use the aligned binary file from insightface, this is the tool to restore
       the aligned images from binary file.
'''
