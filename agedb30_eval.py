...
@file: agedb30_eval.py
@time: 2018/12/25 19:05
@desc: The AgeDB-30 test protocol is same with LFW, so I just copy the code from lfw_eval.py
'''
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', type=str, default='./model/CASIA_v1_20181224_154708/045.ckpt',
    ...
    net, device, agedb_dataset, agedb_loader = loadModel(args.root, args.file_list, args.gpus, args.resume)
